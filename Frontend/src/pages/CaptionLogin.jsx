          ...
          <div className='bg-transparent border border-white bg-opacity-5 backdrop-blur-[3px] rounded-2xl shadow-lg p-4 sm:p-6 md:p-8'>
            ...
            <div className='mt-4 sm:mt-6 text-center'>
              <p className='text-white text-sm sm:text-base'>
                Join as a Caption?{' '}
                <a href='/caption-signup' className='text-white hover:text-blue-800 text-lg sm:text-xl font-bold transition-colors duration-200'>
                  Sign Up
                </a>
              </p>
            </div>
